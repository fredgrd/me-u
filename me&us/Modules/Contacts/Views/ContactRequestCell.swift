...
class ContactRequestCell: UICollectionViewCell {
    ...
    let cancelRequestButton = IconButton()
    let resendRequestButton = IconButton()
...
// MARK: - UISetup
private extension ContactRequestCell {
    func setupUI() {
...
//        setupAddButton()
    ...
    func setupDetails() {
        ...
        nameLabel.font = .font(ofSize: 17, weight: .medium)
